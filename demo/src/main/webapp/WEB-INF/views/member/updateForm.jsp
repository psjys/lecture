		...
		<table>
			...
			<tr height="40">
				...
				<td><select name="jno">
						...
						<option value="3" ${apple.jno==3? "selected" : "" }>3조:백업은
							기본이조</option>
						<option value="4" ${apple.jno==4? "selected" : "" }>4조:상호형
							빵사조</option>
			...
			<tr height="40">
				...
				<td><input type="text" name="info" size="20"
					value="${apple.info}"></td>
			</tr>
			<tr height="40">
			...
			<tr height="40">
				...
				<td><input type="date" name="birthday" size="20"
					value="${apple.birthday}"></td>
			</tr>
			<tr height="40">
				<td bgcolor="GreenYellow">추천인</td>
				<td><input type="text" name="rid" size="20"
					value="${apple.rid}"></td>
			</tr>

			<!-- image update 추가 
   			=> form Tag : method (무조건 post) enctype 확인 
   			=> new Image 를 선택하는 경우 -> uploadfilef 사용
   			=> new Image 를 선택하지 않는 경우
    ...
    -->
			...
			<tr height="40">
				...
				<td><img src="${apple.uploadfile}" class="select_img"
					width="80" height="100"> <input type="hidden"
					name="uploadfile" value="${apple.uploadfile}"><br> <input
					type="file" name="uploadfilef" size="20"
					value="${apple.uploadfile}"></td>
				<script>
					$('#uploadfilef').change(
							function() {
